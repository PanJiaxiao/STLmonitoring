...
i = 9;
%5 6
fileload = 'USA_US101-23_1_T-1-multi-planner-simulation-result-6.mat';
load(fileload);
...
if startsWith(problem, 'USA')
    ...
    yyaxis right
    plot(t, trace(4,2:50)',  'r', 'LineWidth', 2);
    set(gca, 'LineWidth', 2, 'FontSize',18)
    yyaxis left
    plot(t, trace(2,2:50)', 'g', 'LineWidth', 2);
    hold on
    plot(t, trace(3,2:50)', 'b', 'LineWidth', 2);
    legend('distance','va-acc','lan-o-a');
    grid on;
    xlim([0 49]);
    xticks(0:5:50);
else
