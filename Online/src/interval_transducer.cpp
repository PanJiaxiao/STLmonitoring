...
namespace CPSGrader {
    ...
    double and_transducer::compute_lower_rob(){
        ...
        //cout<<"and_z_low"<<childL->z_low<<endl;
        //cout<<"and_z_low"<<childR->z_low<<endl;
    ...
    double and_transducer::compute_upper_rob(){
        ...
        //cout<<"and_z_up"<<childL->z_up<<endl;
        //cout<<"and_z_up"<<childR->z_up<<endl;
...
//         double y1 = childL->compute_lower_rob();
    ...
    double or_transducer::compute_lower_rob(){
        childL->compute_lower_rob();
        childR->compute_lower_rob();
        //cout<<"or_z_low"<<childL->z_low<<endl;
        //cout<<"or_z_low"<<childR->z_low<<endl;
    ...
    double or_transducer::compute_upper_rob(){
        childL->compute_upper_rob();
        childR->compute_upper_rob();
        //cout<<"or_z_up"<<childL->z_up<<endl;
        //cout<<"or_z_up"<<childR->z_up<<endl;
...
//         }
    ...
    double until_transducer::compute_lower_rob() {
        ...
        double i;
        i=childL->compute_lower_rob();
        //cout<<"childL->compute_lower_rob()"<<i<<endl;
        if (childL->compute_lower_rob()==BOTTOM) {
            z_low.appendSample(start_time, BOTTOM);
            return BOTTOM;}
        if (childR->compute_lower_rob()==BOTTOM) {
            z_low.appendSample(start_time, BOTTOM);
            return BOTTOM;}
        
        Signal y1 = childL->z_low;
        Signal y2 = childR->z_low;

        childL->z_low.beginTime=0.;
        childR->z_low.beginTime=0.;
        childL->z_low.endTime=90.;
        childR->z_low.endTime=90.;
    ...
    double until_transducer::compute_upper_rob() {
        ...
        if (childL->compute_upper_rob()==TOP) {
            z_up.appendSample(start_time, TOP);
            return TOP;}
        //cout<<"get in R"<<endl;
        if (childR->compute_upper_rob()==TOP) {
            z_up.appendSample(start_time, TOP);
            //cout<<"before return"<<endl;
            return TOP;}
        //cout<<"get out R"<<endl;
        Signal y1 = childL->z_up;
        Signal y2 = childR->z_up;
        //cout<<"childL->z_up:"<< y1<<endl;
        //cout<<"childR->z_up:"<< y2<<endl;
        childL->z_up.beginTime=0.;
        childR->z_up.beginTime=0.;
        childL->z_up.endTime=90.;
        childR->z_up.endTime=90.;
