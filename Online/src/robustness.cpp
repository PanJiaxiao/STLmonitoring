...
Signal * computeUntil(Signal * x, Signal * y) {
    ...
    //cout<<"x->btime:"<<x->beginTime<<endl;
    //cout<<"x->etime:"<<x->endTime<<endl;
    //cout<<"fmax"<<endl;
	z->beginTime = fmax(x->beginTime, y->beginTime);
    //cout<<"fmin"<<endl;
	z->endTime = fmin(x->endTime, y->endTime);
    //cout<<"fout"<<endl;
    //cout<<"z_etime"<<z->endTime<<endl;
    //cout<<"z_btime"<<z->beginTime<<endl;
	while (i->time >= z->endTime){
